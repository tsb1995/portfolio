...
function getUserMediaSupported() {
  ...
  if (getUserMediaSupported()) {
    cocoEnableWebcamButton.addEventListener('click', enableCam);
  } else {
...
// Occurs once eventListener detecks click on enableCam
...
function cocoPredictWebcam() {
  ...
  model.detect(cocoVideo).then(function (predictions) {
